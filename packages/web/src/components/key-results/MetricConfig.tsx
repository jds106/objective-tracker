...
export function MetricConfig({ config, onChange, checkInMode }: MetricConfigProps) {
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-3 gap-3">
        <div>
          ...
          {checkInMode ? (
            <p className="mt-1 text-sm text-slate-300">{config.startValue}</p>
          ) : (
            <input
              id="metric-start"
              type="number"
        ...
        <div>
          ...
          {checkInMode ? (
            <p className="mt-1 text-sm text-slate-300">{config.targetValue}</p>
          ) : (
            <input
              id="metric-target"
              type="number"
      ...
      {checkInMode ? (
        <div className="flex items-center gap-4 text-sm text-slate-400">
          ...
          <span className="capitalize">{config.direction}</span>
        </div>
      ) : (
